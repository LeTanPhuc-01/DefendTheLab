...
| :---: | :---: |
| <img src="my-webtouch-app/docs/media/demo/kiosk_initial.png" width="100%"> | <img src="my-webtouch-app/docs/media/demo/kiosk_game.png" width="100%"> |

### 📱 Mobile Controller
| Navigation Mode | Drawing Mode |
| :---: | :---: |
| <img src="my-webtouch-app/docs/media/demo/controller_menu.jpg" width="100%"> | <img src="my-webtouch-app/docs/media/demo/controller_game.jpg" width="100%"> |

### 🏆 Leaderboard
<div align="center">
  <img src="my-webtouch-app/docs/media/demo/leaderboard.png" width="60%">
  <br>
...
### 1. Environment Setup
Create a `.env` file in the `my-webtouch-app/` directory to configure your database and server port.
...
4.  **Defend!**:
    ...
    *   Write the answer on your phone screen to destroy the virus!
    ![Controls](my-webtouch-app/docs/media/demo/controls.png)
...
The project follows a "Thick-Server" architecture. The **Phaser** game logic is located in `my-webtouch-app/src/game_logic/`.
